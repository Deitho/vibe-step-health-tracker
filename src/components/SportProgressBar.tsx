...
export function SportProgressBar({ current, total, actions }: SportProgressBarProps) {
    const isComplete = current >= total;

    return (
        <div className="w-full max-w-sm mx-auto mb-6 rounded-xl border border-white/[0.06] bg-white/[0.03] backdrop-blur-md">
